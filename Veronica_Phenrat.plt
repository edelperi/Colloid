...
set output "VP_Correlation_ink.eps"
...
plot '< awk -f ./VPHR.awk' u 1:2 t "{/Symbol h}_D"  w l ls 1,\
'< awk -f ./VPHR.awk' u 1:3 t "{/Symbol h}_I" w l ls 2,\
'< awk -f ./VPHR.awk' u 1:4 t "{/Symbol h}_G" w l ls 3,\
'< awk -f ./VPHR.awk' u 1:5  t "{/Symbol h}_0 = {/Symbol h}_D+{/Symbol h}_I+{/Symbol h}_G"  w l ls 4,\
...
plot '< awk -f ./VPHR.awk' u 1:2 t ""  w l ls 1,\
'< awk -f ./VPHR.awk' u 1:3 t "" w l ls 2,\
'< awk -f ./VPHR.awk' u 1:4 t "" w l ls 3,\
'< awk -f ./VPHR.awk' u 1:5  t ""  w l ls 4,\
